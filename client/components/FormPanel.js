...
function FormPanel({ title, btnName, submitCallback, model }) {
  ...
  const Components = { TextInput, RadioInput, TextareaInput, CheckboxInput, SelectInput, PasswordInput };
  ...
  return (
    <section>
     {title && <h1 className="uk-heading-divider uk-text-center uk-margin-top">{title}</h1>}
      <form>
